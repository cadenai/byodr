# docker build -f jp43-nano-cp36-tf115-opencv440.dockerfile -t centipede2donald/nvidia-jetson:jp43-nano-cp36-tensorflow-115-opencv-440 .
FROM centipede2donald/nvidia-jetson:jp43-nano-cp36-tensorflow-115
