...
class TFDriver(object):
    ...
    def activate(self):
        with self._lock:
            ...
            with graph.as_default():
                ...
                self.tf_gumbel = graph.get_tensor_by_name('fm/output/gumbel:0')
    ...
    def forward(self, dave_image, alex_image, turn, dagger=False):
        with self._lock:
            ...
            _ops = [self.tf_steering, self.tf_brake, self.tf_surprise, self.tf_critic, self.tf_entropy, self.tf_gumbel]
            ...
            with self.sess.graph.as_default():
                ...
                try:
                    _steer, _brake, _surprise, _critic, _entropy, _gumbel = self.sess.run(_ops, feed_dict=feeder)
                    return _steer, max(0, _brake), _surprise, max(0, _critic), _entropy, _gumbel
